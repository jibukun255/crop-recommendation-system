...
def fetch_soil_data(lat, lon):
    """
    Returns realistic soil NPK and pH based on geographic region.
    Values derived from FAO/ISRIC regional soil reports and
    African Soil Information Service (AfSIS) continental data.
    """
    defaults           = get_regional_soil_defaults(lat, lon)
    defaults["source"] = "FAO regional soil data"
    return defaults
